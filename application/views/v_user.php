	...
	<div class="wrapper-konten">
		<div class="card">
			...
			<div class="card-body">
				...
				<a href="<?php echo base_url('user/halaman_tambah') ?>"><button class="btn btn-primary" >Tambah Data</button></a>
				<br>
				<br>
					...
					<tbody>
						...
						foreach ($queryAllUsr as $row){
							...
							<tr>
								...
								foreach ($queryAllWil as $row1){
									if ($row1->id_wilker ==$row->id_wilker) {

										?>
										<td><?php echo $row1->wilker ?></td>
								<?php }}   ?>
